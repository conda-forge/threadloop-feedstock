...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/threadloop-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2342&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/threadloop-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `threadloop` can be installed with:

```
conda install threadloop
```

It is possible to list all of the versions of `threadloop` available on your platform with:
